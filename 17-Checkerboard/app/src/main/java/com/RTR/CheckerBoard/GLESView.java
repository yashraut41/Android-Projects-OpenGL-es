...
;
		...
		fragmentShaderObject=GLES32.glCreateShader(GLES32.GL_FRAGMENT_SHADER);
		 ...
		 if(iShaderCompileStatus[0]==GLES32.GL_FALSE)
		 {
			...
			//create buffer from our  rectangle TexCoord array so we can pass it to glBufferData()
			...
			//now put our array of rectangleTexCoord into these cooked buffer
			...
			GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, rectangleTexCoord.length*4, positionBuffer, GLES32.GL_STATIC_DRAW);
			...
			checkerboardTexture[0]=loadTexture();
